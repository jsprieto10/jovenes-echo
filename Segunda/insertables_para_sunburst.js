...
<div id="quitame" style="height: 100%; width: 100%">
    ...
    <p>Segunda Mesa Sectorial de Jóvenes. 19/02/2020. Realizada en Cámara de Comercio de Bogotá, Colombia. Participación de aprox. 400  jóvenes y altos funcionarios del gobierno nacional, organizados en 30 mesas de tématicas con representación de jóvenes distintas regiones del país, distintas tendencias políticas, causas, y grupos de minorías.</p>
    </div>
...
var profundidad_2 = `
<div id="quitame_2" style="height: 100%; width: 100%">
    <div style="position: absolute; width: 30vw; top: 40px; left: 0;">
    <h2 id="barrio-h_2" style="font-size: 3rem;">Gran Conversación Nacional: <span style="color:#f48633;">Jóvenes<span></h2>
    </div>
    ...
    <div class="row" style="height: 41%">
        <div class="col-6" style="height: 100%">
            <div class="row" style="height: 30%; ">
                <div class="col-12" style="overflow: hidden; max-height: 100%; height: 100%; text-align: center">
                    <div style="display: flex; margin: auto; height:100%">
                        <h1 id="percent_ods_2" style="margin: auto auto 0 auto"></h1>
                    </div>
                </div>

            </div>
            <div class="row" style="height: 70%; ">
                <img width="55%" height="100%" src="" id="imagen_ods_sun_2" class="imagen_sun" style="border:0px solid black; margin: 0 auto">
            </div>
        </div>
        <div class="col-6" style="height: 100%">
            <div id="5_0r" class="row" style="height: 20%; "></div>
            ...
            <div class="row" style="height: 50%; ">
                <div class="col-12" style="height: 100%; padding-left: 0">
                    <img src="" id="imagen_meta_sun_2" class="imagen_sun"
                        style="max-height: 100%; border:0px solid black;">
                </div>
            </div>
        </div>
    ...
    <div class="row" style="height: 19%">
        <div class="col-12" style="height: 100%">
            <h1 id="desc_meta_sun_2" style="text-align: right; font-size: 120%; margin-top: 3%">
            </h1>
        </div>
    </div>
</div>
...
<div id="quitame_2">
        ...
        <div class="row vh-15">
            <div class="col-3">
                <img src="" id="imagen_3meta_sun_2" align="right" style="width: 90%; height: 90%;">
            </div>
            <div class="col-9">
                <div class="barras_metas_sun row pr-25">
                    <div id="prueba_barrita_2" class="perc_barras_metas_sun col-12" style="height: 100%; padding: 0">
    
                    </div>
                </div>
                <div class="row pr-75">
                    <div class="col-12">
                            <h1 id="desc_meta_sun_int_primera_2" class="desc_meta_sun_int"
                            style="text-align: right; font-size: 2.5vh!important; margin-top: 3%; font-style: italic; margin-right: 4vw">
                            "Reducir el impacto ambiental de las ciudades."</h1>
                    </div>
                </div>
