    ...
    if (vises == 3) {
        if (!imwaitingforubaby) {
            ...
            setTimeout(function () {
                ...
                $("#nav").append(`<select class="selectpicker" multiple>
    ...
    if (!cargado) {
        ...
        if (imwaitingforubaby) {
            setTimeout(function () {
                ...
                $("#nav").append(`
                <div>
                    <select id="s-pregunta" class="selectpicker" multiple title="Escoge Pregunta">
                        <option value=0>¿Cuáles son los tres principales problemas que...</option>
                        <option value=1>¿Enumerar 3 temas que los jóvenes comparten co...</option>
                        <option value=2>¿Qué medidas propone para que los jóvenes pued...</option>
                        <option value=3>¿Cuál debe ser el trabajo y programas que se d...</option>
                        <option value=4>¿De que manera podría el gobierno trabajar con...</option>
                        <option value=5>¿Qué otras acciones podrían realizarse para me...</option>
                    </select>
                    <select id="s-genero" class="selectpicker" multiple title="Escoge genero">
                        <option value="Femenino">Femenino</option>
                        <option value="Masculino">Masculino</option>
                    </select>
                    
                <button id="btn-filtrar" type="button" class="btn btn-light">Filtrar</button>
                </div>
              `);
              
                $('select').selectpicker();

                $('#btn-filtrar').click(function(c){
                    let preguntas = $("#s-pregunta").val();
                    let generos = $("#s-genero").val();


                    postData(urlBack+'plataforma', {"respuesta":preguntas, "generos":generos}).then(data => {
                        data.name = "ODS";
